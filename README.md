...
R package **reportbrick**, version **0.6.0**
...
Hasse R, Rosemann R (2024). _reportbrick: Reporting package for BRICK_. R package version 0.6.0, <https://github.com/pik-piam/reportbrick>.
