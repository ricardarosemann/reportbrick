...
reportDemolition <- function(gdx, tmpl = NULL) {
  ...
  out <- mbind(
    ...
    ## by location ====
    reportAgg(v_demolition,
              "Demolition|Residential|{loc} (bn m2/yr)", tmpl,
    ...
    ## by vintage ====
    reportAgg(v_demolition,
              "Demolition|Residential|{vin} (bn m2/yr)", tmpl,
    ...
    ## by heating system ====
    reportAgg(v_demolition,
              "Demolition|Residential|{hs} (bn m2/yr)", tmpl,
    ...
    reportAgg(v_demolition,
              "Demolition|Residential|{typ}|{hs} (bn m2/yr)", tmpl,
