...
.showLtPlot <- function(plotType, data, varName, yname, color,
                        ...
                        xname = "ttotOut", suppressLateTtot = TRUE,
...
wbRemainStub <- data %>%
  ...
  select(-"variable", -"ttotOut", -"relVal", -"absVal", -"value", -"costType", -"hsr", -"bsr") %>%
  unique() %>%
  mutate(absVal = NA, value = NA, costType = NA, hsr = NA, bsr = NA)

wbRemainStockStub <- data %>%
  filter(grepl("stock.*Remain", .data$variable)) %>%
  select(-"variable", -"ttotIn", -"ttotOut", -"relVal", -"absVal", -"value", -"costType", -"hsr", -"bsr") %>%
  unique() %>%
  mutate(ttotIn = 2000, absVal = NA, value = NA, costType = NA, hsr = NA, bsr = NA)
...
wbRemainStock <- wbRemain %>%
  ...
  mutate(ttotOut = 2000 - 12 + .data$x,
         variable = "wbRemainStock") %>%
  select(-"x")

wbRemain <- wbRemain %>%
  left_join(wbRemainStub, by = c("region", "typ", "hs")) %>%
  mutate(ttotOut = .data$ttotIn + .data$x - 5/2,
         variable = "wbRemain") %>%
  select(-"x")
...
#   group_by(across(all_of(c("qty", "bs", "hs", "vin", "region", "loc", "typ", "inc", "ttotIn", "costType", "hsr", "bsr")))) %>%
#   mutate(across(matches("^(?!wb).*Remain$", perl = TRUE), ~ .data$wbRemain[.data$ttotOut == .data$ttotIn] * .x)) %>%
#   ungroup()
...
dataRemainStock <- wbRemainStockStub %>%
  crossing(ttotOut = unique(dataRemainStock$ttotOut), variable = unique(dataRemainStock$variable)) %>%
  left_join(dataRemainStock) %>%
  mutate(relVal = ifelse(
    is.na(.data$relVal) & .data$ttotOut == 2000,
    1,
    .data$relVal
  )) %>%
  rbind(wbRemainStock) %>%
  pivot_wider(names_from = "variable", values_from = "relVal") %>%
  group_by(across(all_of(c("qty", "bs", "hs", "vin", "region", "loc", "typ", "inc", "ttotIn", "costType", "hsr", "bsr")))) %>%
  mutate(across(matches("stock.*Remain"), ~ .data$wbRemainStock[.data$ttotOut == 2000] * .x)) %>%
  ungroup() %>%
...
.showLtPlot("bar", data, "conLtPost", yname = "absVal", color = "hs", rprt = "ttotIn",
            xlabName = "Time of removal", ylabName = "Quantity in million m2", tmpl = tmpl)
...
.showLtPlot("bar", data, "conLtAnte", yname = "absVal", color = "hs", rprt = "ttotIn",
            xlabName = "Time of removal", ylabName = "Quantity in million m2", tmpl = tmpl)
...
.showLtPlot("bar", data, "conLtAnteC", yname = "absVal", color = "hs", rprt = "ttotIn",
            xlabName = "Time of removal", ylabName = "Quantity in million m2", tmpl = tmpl)
...
.showLtPlot("bar", data, "conLtMixed", yname = "absVal", color = "hs", rprt = "ttotIn",
            xlabName = "Time of removal", ylabName = "Quantity in million m2", tmpl = tmpl)
...
.showLtPlot("bar", data, "conLtPost", yname = "relVal", color = "hs", rprt = "ttotIn",
            xlabName = "Time of removal", ylabName = "Share of installations", tmpl = tmpl)
...
.showLtPlot("bar", data, "conLtAnte", yname = "relVal", color = "hs", rprt = "ttotIn",
            xlabName = "Time of removal", ylabName = "Share of installations", tmpl = tmpl)
...
.showLtPlot("bar", data, "renLtPost", yname = "absVal", color = "hs", rprt = "ttotIn",
            xlabName = "Time of removal", ylabName = "Quantity in million m2", tmpl = tmpl)
...
.showLtPlot("bar", data, "renLtAnte", yname = "absVal", color = "hs", rprt = "ttotIn",
            xlabName = "Time of removal", ylabName = "Quantity in million m2", tmpl = tmpl)
...
.showLtPlot("bar", data, "renLtAnteC", yname = "absVal", color = "hs", rprt = "ttotIn",
            xlabName = "Time of removal", ylabName = "Quantity in million m2", tmpl = tmpl)
...
.showLtPlot("bar", data, "renLtMixed", yname = "absVal", color = "hs", rprt = c("vin", "ttotIn"),
            xlabName = "Time of removal", ylabName = "Quantity in million m2", tmpl = tmpl)
