...
params:
    ...
    path: "C:/Users/ricardar/Documents/PIAM/brick/output/noShellEUR_2024-08-30_11.38.08"
    scenNames: NULL
    savePlots: TRUE
    name: ""
---
...
.createLtPlot <- function(data, varName, yname, color,
                          rprt = NULL, avg = NULL, xname = "ttot2", noFacets = FALSE, xlabName = NULL, ylabName = NULL) {
...
.createLtTwoBar <- function(data, varName, yname, color,
                            xname = "ttot2", remCols = NULL, rprt = NULL, xlabName = NULL, ylabName = NULL) {
...
.createLtPlot(data %>% filter(loc == "rural", typ == "MFH"), "conLccAnte",
              xname = "hs", yname = "value", color = "costType", rprt = "vin",
...
### Energy ladder position 1

```{r Plot logit shares of renovation with ex-ante lifetimes, energy ladder 1}
.createLtPlot(data %>% filter(loc == "rural", typ == "MFH"), "renLogitEl1Ante",
              xname = "ttot", yname = "value", color = "hs", rprt = "vin", noFacets = TRUE,
              xlabName = "Time of installation", ylabName = "Shares")
```

### Energy ladder position 2

```{r Plot logit shares of renovation with ex-ante lifetimes, energy ladder 2}
.createLtPlot(data %>% filter(loc == "rural", typ == "MFH"), "renLogitEl2Ante",
              xname = "ttot", yname = "value", color = "hs", rprt = "vin", noFacets = TRUE,
              xlabName = "Time of installation", ylabName = "Shares")
```

### Energy ladder position 3

```{r Plot logit shares of renovation with ex-ante lifetimes, energy ladder 3}
.createLtPlot(data %>% filter(loc == "rural", typ == "MFH"), "renLogitEl3Ante",
              xname = "ttot", yname = "value", color = "hs", rprt = "vin", noFacets = TRUE,
              xlabName = "Time of installation", ylabName = "Shares")
```
...
.createLtPlot(data %>% filter(loc == "rural", typ == "MFH"), "renLogitEl1Mixed",
              xname = "ttot", yname = "value", color = "hs", rprt = "vin", noFacets = TRUE,
              xlabName = "Time of installation", ylabName = "Shares")
```
...
```{r Plot logit shares of renovation with mixed lifetimes, energy ladder 2}
.createLtPlot(data %>% filter(loc == "rural", typ == "MFH"), "renLogitEl2Mixed",
              xname = "ttot", yname = "value", color = "hs", rprt = "vin", noFacets = TRUE,
              xlabName = "Time of installation", ylabName = "Shares")
```
...
```{r Plot logit shares of renovation with mixed lifetimes, energy ladder 3}
.createLtPlot(data %>% filter(loc == "rural", typ == "MFH"), "renLogitEl3Mixed",
              xname = "ttot", yname = "value", color = "hs", rprt = "vin", noFacets = TRUE,
              xlabName = "Time of installation", ylabName = "Shares")
```
...
.createLtTwoBar(data %>% filter(.data[["ttot"]] <= 2040), c("renLogitEl1Mixed", "renBrickEl1"),
...
```{r Plot Logit and brick Share with mixed lifetimes, energy ladder 2}
.createLtTwoBar(data %>% filter(.data[["ttot"]] <= 2040), c("renLogitEl2Mixed", "renBrickEl2"),
                yname = "value", xname = "ttot", color = "hs", rprt = "vin",
                xlabName = "Time of installation", ylabName = "Shares")
```
...
```{r Plot Logit and brick Share with mixed lifetimes, energy ladder 3}
.createLtTwoBar(data %>% filter(.data[["ttot"]] <= 2040), c("renLogitEl3Mixed", "renBrickEl3"),
                yname = "value", xname = "ttot", color = "hs", rprt = "vin",
                xlabName = "Time of installation", ylabName = "Shares")
```
